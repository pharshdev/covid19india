...
NationalData nationalDataFromJson(String str) =>
    NationalData.fromJson(json.decode(str));

String nationalDataToJson(NationalData data) => json.encode(data.toJson());
...
class NationalData {
  ...
  factory NationalData.fromJson(Map<String, dynamic> json) => NationalData(
